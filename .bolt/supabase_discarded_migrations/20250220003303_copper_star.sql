...
CREATE POLICY "progress_view_policy_v2"
  ON company_progress
  FOR SELECT
  USING (
    EXISTS (
...
CREATE POLICY "progress_manage_policy_v2"
  ON company_progress
  FOR ALL
  USING (
    EXISTS (
...
CREATE POLICY "suggestions_view_policy_v2"
  ON company_step_suggestions
  FOR SELECT
  USING (is_public = true);

CREATE POLICY "suggestions_manage_policy_v2"
  ON company_step_suggestions
  FOR ALL
