...
CREATE INDEX IF NOT EXISTS idx_companies_competitive_analysis ON companies USING gin(competitive_analysis);
CREATE INDEX IF NOT EXISTS idx_companies_funding_status ON companies USING gin(funding_status);
CREATE INDEX IF NOT EXISTS idx_companies_revenue_model ON companies USING gin(revenue_model);
CREATE INDEX IF NOT EXISTS idx_companies_financial_metrics ON companies USING gin(financial_metrics);
CREATE INDEX IF NOT EXISTS idx_companies_team_structure ON companies USING gin(team_structure);
CREATE INDEX IF NOT EXISTS idx_companies_product_roadmap ON companies USING gin(product_roadmap);
