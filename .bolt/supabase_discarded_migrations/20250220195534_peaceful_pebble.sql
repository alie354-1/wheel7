...
CREATE INDEX idx_tools_company_stages ON tools USING gin(company_stages);
CREATE INDEX idx_tools_company_sizes ON tools USING gin(company_sizes);
CREATE INDEX idx_tools_business_models ON tools USING gin(business_models);
CREATE INDEX idx_tools_industries ON tools USING gin(industries);
