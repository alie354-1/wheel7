/*
  ...
  1. New Tables
    - community_posts
      ...
      - Voting counts
      - Pinning and locking flags
    - community_comments
      - Comment content
      - Parent/child relationship
      - Voting counts
    - community_post_votes
      - Post voting tracking
    - community_comment_votes
      - Comment voting tracking

  2. Security
    - Enable RLS on all tables
    - Add appropriate policies
    - Set up vote tracking triggers
*/
...
-- Create community_comments table with parent_id
...
-- Add parent_id column separately to handle self-referential foreign key
